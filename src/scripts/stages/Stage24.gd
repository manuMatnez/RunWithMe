...
const CAMERA_LIMIT_LEFT = -700
const CAMERA_LIMIT_TOP = -1100
const CAMERA_LIMIT_RIGHT = 7200
const CAMERA_LIMIT_BOTTOM = 1000

func _ready():
	set_name(GlobalMusic.stage24)
	...
	get_node("Coins/Coin7").SUMATORI_MAX_POS = 200.0
	get_node("Coins/Coin9").SUMATORI_MAX_POS = 300.0
